 ...
 * 
 * @help
 * 各種レイアウト(コマンドやタッチUIの位置)を手軽に変更するよ
 * オプションでプレイヤーにレイアウトを変更させることもできるよ
 * 
 *
 *
 * ◉ レイアウト変更 ◉
 * メニューやバトルの位置レイアウトを変更できる
 * 設定はパラメータの『レイアウト変更』で行う
 *
 * ■メニューコマンド位置
 ...
 *
 * ◉ 連動設定 ◉
 * レイアウト変更の際の連動関係を調整できる
 * 設定はパラメータの『連動設定』で行う
 *
 * ■装備コマンド連動
 * メニューコマンド位置を左にしたとき、
 * 装備コマンドの位置も左にする(デフォは右固定)
 *
 * ■プロフィール連動
 * メニューヘルプ位置を上にしたとき、
 * ステータス画面のプロフィール欄の位置も上にする(デフォは下固定)
 * 
 *
 * ◉ オプション ◉
 * オプションからもレイアウトを変更できる
 * 設定はパラメータの『オプションリスト』で行う
 *
 * ■項目の表示順を変えたい場合
 * オプションリストの順番を変える
 *
