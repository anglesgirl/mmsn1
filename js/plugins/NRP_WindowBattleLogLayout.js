...
/*:
 * @target MZ
 * @plugindesc v1.03 Change the layout of the battle log.
...
/*:ja
 * @target MZ
 * @plugindesc v1.03 戦闘メッセージのレイアウトを変更します。
...
var parameters = PluginManager.parameters("NRP_WindowBattleLogLayout");
var pX = parameters["x"];
var pY = parameters["y"];
var pWidth = parameters["width"];
var pAutoWidth = toBoolean(parameters["autoWidth"]);
var pLineHeight = toNumber(parameters["lineHeight"]);
var pNormalWindow = toBoolean(parameters["normalWindow"]);
var pShowFront = toBoolean(parameters["showFront"]);
var pFontSize = toNumber(parameters["fontSize"]);
var pPadding = toNumber(parameters["padding"]);
var pBackColor = parameters["backColor"];
var pBackPaintOpacity = toNumber(parameters["backPaintOpacity"]);
var pGradientType = parameters["gradientType"];
var pStartGradientSize = parameters["startGradientSize"];
var pEndGradientSize = parameters["endGradientSize"];
...
if (Utils.RPGMAKER_NAME == "MZ") {
     ...
     */
    var isSimpleMsgSideViewMZ = PluginManager._scripts.some(function(scriptName) {
